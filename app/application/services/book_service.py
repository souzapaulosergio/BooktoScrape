...
class BookService:
    ...
    def obter_categorias(self):
        """Obter todas as categorias de livros disponíveis no site"""         
    ...
    def obter_livros(self,nome_categoria, url_categoria):
        ...
        books = []
        url = url_categoria
        base_dir = os.path.join(os.path.dirname(__file__), "imagens")
        ...
        while url:
            ...
            pasta_categoria = os.path.join(base_dir, nome_categoria)
            ...
            for item in items:
                ...
                if img_url:
                    try:
                        ...
                        img_nome = os.path.basename(img_tag["src"])
                        caminho_img = os.path.join(pasta_categoria, img_nome)
                        with open(caminho_img, "wb") as f:
                            f.write(img_data)
                    except Exception as e:
                              print(f"Erro ao baixar imagem de {title}: {e}")
